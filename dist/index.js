...
(function () {
	...
	var css_248z = "body {\r\n  margin: 0;\r\n  --color-dark: rgb(31, 35, 41);\r\n  --color-light: rgb(234, 235, 230);\r\n  --color-light-green: rgb(223, 245, 213);\r\n  --color-light-blue: powderblue;\r\n  --text-font: Verdana, Sans-Serif;\r\n}\r\n\r\n[hidden] {\r\n  display: none;\r\n}\r\n";
...
<div class='container'>
  <h1 id='header'><slot></slot></h1>
	...
	class MainPageHeader extends HTMLElement {
	    constructor() {
	        super();
	        this.attachShadow({ mode: 'open' });
	        const content = template$1.content.cloneNode(true);
	        this.shadowRoot.appendChild(content);
	        this.header = this.shadowRoot.querySelector('#header');
	    }
	    connectedCallback() {
	        this.header.addEventListener('pointerenter', (e) => this.handleHeaderPointerEnter(e));
	        this.render();
	    }
	    disconnectedCallback() {
	        this.header.removeEventListener('pointerenter', (e) => this.handleHeaderPointerEnter(e));
	    }
	    attributeChangedCallback() {
	        this.render();
	    }
	    render() { }
	    handleHeaderPointerEnter(e) {
	...
	const areEqualObjects = (first, second) => {
	...
	const stubItems = generateItems();

	const SET_ORDERED_ITEMS = 'SET_ORDERED_ITEMS';
	const SET_ORDERED_ITEMS_MAP = 'SET_ORDERED_ITEMS_MAP';

	function setOrderedItems(newOrderedItems) {
	    return {
	...
	function setOrderedItemsMap(newOrderedItemsMap) {
	    return {
	...
	const todoListReducer = (state = defaultTodoListState, action) => {
	    switch (action.type) {
	        case SET_ORDERED_ITEMS:
	            return Object.assign(Object.assign({}, state), { orderedItems: action.payload.orderedItems });
	        case SET_ORDERED_ITEMS_MAP:
	            return Object.assign(Object.assign({}, state), { orderedItemsMap: action.payload.orderedItemsMap });
	        default:
	            return state;
	    }
	};
	...
	***************************************************************************** */
	...
	const getBoundingClientRectObj = (object) => {
...
`;
	...
	class ListItem extends HTMLElement {
	    constructor(id, text) {
	        ...
	        this.attachShadow({ mode: 'open' });
	        const content = template$2.content.cloneNode(true);
	        this.shadowRoot.appendChild(content);
	    ...
	    animateReordering(direction) {
	        return __awaiter(this, void 0, void 0, function* () {
	            const itemBcr = getBoundingClientRectObj(this);
	...
	class DragAndDrop {
	    ...
	    addDragApiListeners() {
	        this.container.addEventListener('dragstart', (e) => this.dragStartHandler(e));
	        this.container.addEventListener('drag', (e) => this.dragHandler(e));
	        this.container.addEventListener('dragover', (e) => this.dragOverHandler(e));
	        this.container.addEventListener('dragleave', (e) => this.dragLeaveHandler(e));
	        this.container.addEventListener('drop', (e) => this.dropHandler(e));
	        this.container.addEventListener('dragend', (e) => this.dragEndHandler(e));
	    }
	    removeDragApiListeners() {
	        this.container.removeEventListener('dragstart', (e) => this.dragStartHandler(e));
	        this.container.removeEventListener('drag', (e) => this.dragHandler(e));
	        this.container.removeEventListener('dragover', (e) => this.dragOverHandler(e));
	        this.container.removeEventListener('dragleave', (e) => this.dragLeaveHandler(e));
	        this.container.removeEventListener('drop', (e) => this.dropHandler(e));
	        this.container.removeEventListener('dragend', (e) => this.dragEndHandler(e));
	    }
	    ...
	    dragStartHandler(e) {
	        ...
	        if (item) {
	            document.addEventListener('dragover', (e) => this.saveCoordinates(e));
	    ...
	    dragOverHandler(e) {
	        var _a;
	        const item = this.getListElementFromEvent(e);
	        if (item && item.id !== ((_a = this.draggedItem) === null || _a === void 0 ? void 0 : _a.id)) {
	    ...
	    dragEndHandler(e) {
	        ...
	        document.removeEventListener('dragover', (e) => this.saveCoordinates(e));
...
`;
	...
	class TodoList extends HTMLElement {
	    constructor() {
	        ...
	        this.attachShadow({ mode: 'open' });
	        const content = template$3.content.cloneNode(true);
	        this.shadowRoot.appendChild(content);
	    ...
	    disconnectedCallback() {
	        var _a;
	        this._storeUnsubscribe();
	        (_a = this.dragAndDrop) === null || _a === void 0 ? void 0 : _a.disable();
	    }
	    stateChanged(state) {
