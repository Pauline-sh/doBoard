...
var relative = require$$0__default$1['default'].relative;
...
var extname = require$$0__default$1['default'].extname;
...
var parse$6 = url__default['default'].parse;
...
var basename$1 = require$$0__default$1['default'].basename;
...
function decodefield (str) {
  ...
  switch (charset) {
    case 'iso-8859-1':
      ...
      break
    case 'utf-8':
      value = Buffer$a.from(binary, 'binary').toString('utf8');
      break
    default:
...
function destroy(stream) {
  ...
  if (!(stream instanceof require$$1__default['default'])) {
    return stream
  }
...
function SendStream (req, path, options) {
  require$$1__default['default'].call(this);
...
util__default['default'].inherits(SendStream, require$$1__default['default']);
...
var extname$2 = require$$0__default$1['default'].extname;
var mime$1 = send_1.mime;
var resolve$2 = require$$0__default$1['default'].resolve;
...
res.send = function send(body) {
  ...
  switch (typeof chunk) {
    ...
    case 'object':
      if (chunk === null) {
        chunk = '';
      } else if (Buffer$b.isBuffer(chunk)) {
        if (!this.get('Content-Type')) {
          this.type('bin');
        }
      } else {
  ...
  if (chunk !== undefined) {
    if (Buffer$b.isBuffer(chunk)) {
      ...
      len = Buffer$b.byteLength(chunk, encoding);
    } else {
...
res.redirect = function redirect(url) {
  ...
  this.set('Content-Length', Buffer$b.byteLength(body));
...
var resolve$3 = require$$0__default$1['default'].resolve;
...
var contentSecurityPolicy_1 = createCommonjsModule(function (module, exports) {
...
var expectCt_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var referrerPolicy_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var strictTransportSecurity_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var xContentTypeOptions_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var xDnsPrefetchControl_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var xDownloadOptions_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var xFrameOptions_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var xPermittedCrossDomainPolicies_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var xPoweredBy_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
function xPoweredBy() {
...
var xXssProtection_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
const content_security_policy_1 = __importDefault(contentSecurityPolicy_1);
const expect_ct_1 = __importDefault(expectCt_1);
const referrer_policy_1 = __importDefault(referrerPolicy_1);
const strict_transport_security_1 = __importDefault(strictTransportSecurity_1);
const x_content_type_options_1 = __importDefault(xContentTypeOptions_1);
const x_dns_prefetch_control_1 = __importDefault(xDnsPrefetchControl_1);
const x_download_options_1 = __importDefault(xDownloadOptions_1);
const x_frame_options_1 = __importDefault(xFrameOptions_1);
const x_permitted_cross_domain_policies_1 = __importDefault(xPermittedCrossDomainPolicies_1);
const x_powered_by_1 = __importDefault(xPoweredBy_1);
const x_xss_protection_1 = __importDefault(xXssProtection_1);
...
var helmet = /*@__PURE__*/getDefaultExportFromCjs(dist);

const staticDir = require$$0__default$1['default'].resolve(__dirname + '/../');
const middlewares = [
    lib$2(),
    bodyParser_1.urlencoded({ extended: true }),
    bodyParser_1.json(),
    express$1.static(staticDir),
    helmet({
